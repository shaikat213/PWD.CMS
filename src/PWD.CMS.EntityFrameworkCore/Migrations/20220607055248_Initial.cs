        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OrganizationUnits = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifierId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ToNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrganizaitonUnits", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CivilSubDivisionId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    EmSubDivisionId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifierId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Buildings_Quarters_QuarterId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Apartments_Allotments_AllotmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsCivil = table.Column<bool>(type: "bit", nullable: false),
                    NotifyDivision = table.Column<bool>(type: "bit", nullable: false),
                    NotifyDivisionDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    NotifyCircle = table.Column<bool>(type: "bit", nullable: false),
                    NotifyCircleDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    NotifyZone = table.Column<bool>(type: "bit", nullable: false),
                    NotifyZoneDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Complains_Allotments_AllotmentId",
                        column: x => x.AllotmentId,
                        principalTable: "Allotments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Complains_ProblemTypes_ProblemTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PwdTenants", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PwdTenants_Allotments_AllotmentId",
                        column: x => x.AllotmentId,
                        principalTable: "Allotments",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PwdTenants_Departments_DepartmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ComplainHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ComplainHistories_Complains_ComplainId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Allotments_ApartmentId",
                table: "Allotments",
                column: "ApartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_Allotments_PwdTenantId",
                table: "Allotments",
                column: "PwdTenantId");

            migrationBuilder.CreateIndex(
                name: "IX_Apartments_AllotmentId",
                table: "Apartments",
                column: "AllotmentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Buildings_QuarterId",
                table: "Buildings",
                column: "QuarterId");

            migrationBuilder.CreateIndex(
                name: "IX_ComplainHistories_ComplainId",
                table: "ComplainHistories",
                column: "ComplainId");

            migrationBuilder.CreateIndex(
                name: "IX_Complains_AllotmentId",
                table: "Complains",
                column: "AllotmentId");

            migrationBuilder.CreateIndex(
                name: "IX_Complains_ProblemTypeId",
                table: "Complains",
                column: "ProblemTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_PwdTenants_AllotmentId",
                table: "PwdTenants",
                column: "AllotmentId");

            migrationBuilder.CreateIndex(
                name: "IX_PwdTenants_DepartmentId",
                table: "PwdTenants",
                column: "DepartmentId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Allotments_Apartments_ApartmentId",
                table: "Allotments",
                column: "ApartmentId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Allotments_PwdTenants_PwdTenantId",
                table: "Allotments",
                column: "PwdTenantId",
